...
define("MESSAGE_VERIFICATION_MAIL_SENT", "Your registration request has been sent to the Catalogue Administrators for approval. In a  short time  you will receive their answer. Thanks.");
...
define("WORDING_APPROVAL_EDITING", "Approval process");

define("TOOL_EVALUATION_GRADE_MAX", 8);

define("TOOL_EVALUATION_GRADE_0", "");
define("TOOL_EVALUATION_GRADE_1", "Bad");
define("TOOL_EVALUATION_GRADE_2", "Very Poor");
define("TOOL_EVALUATION_GRADE_3", "Poor");
define("TOOL_EVALUATION_GRADE_4", "Fair");
define("TOOL_EVALUATION_GRADE_5", "Good");
define("TOOL_EVALUATION_GRADE_6", "Very Good");
define("TOOL_EVALUATION_GRADE_7", "Excellent");

define("TOOL_USE_MAX", 8);

define("TOOL_USE_0", "");
define("TOOL_USE_1", "Never");
define("TOOL_USE_2", "Rarely");
define("TOOL_USE_3", "Occasionally");
define("TOOL_USE_4", "Sometimes");
define("TOOL_USE_5", "Often");
define("TOOL_USE_6", "Regularly");
define("TOOL_USE_7", "Always");

...
<form method="post" action="dfte.edit.php" name="user_edit_form_name">
    <label for="user_name"><?php echo WORDING_NEW_USERNAME; ?></label><br/>
...
<form method="post" action="edit.php" name="user_edit_form_password">
    <label for="user_password_old"><?php echo WORDING_OLD_PASSWORD; ?></label><br/>
...
<!-- backlink -->
<a href="dfte.index.php"><?php echo WORDING_BACK_TO_LOGIN; ?></a>

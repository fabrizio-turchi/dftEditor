...
?>
<p class=dftTextItalic><a class=dftLink target="_blank" href=debug/dftc.Catalogue.xlsx>DF Catalogue (xlsx format)></a></p>
</body>
</html>
...
function createSheet($branch, $process) {
    global $objPHPExcel, $db_conn, $codesLeavesNoFeatures;
    ...
    $qryTools  = "SELECT DISTINCT tblTools.IdTool, Tool, LicenseType, OperatingSystem,
        ...
        tblCategories.Process = 'AN' ORDER BY Tool ASC";
...
function prepareRow($rowTool, $row) {
    global $objPHPExcel, $process, $db_conn, $codesLeavesNoFeatures;
...
*/
 ...
 function valueFeature($rowTool, $row) {
    global $objPHPExcel, $codesLeavesNoFeatures, $process, $db_conn;
